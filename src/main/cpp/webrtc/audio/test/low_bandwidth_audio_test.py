...
NO_TOOLS_ERROR_MESSAGE = (
    ...
    'right location.\n'
    'See https://cs.chromium.org/chromium/src/webrtc.third_party/webrtc/tools_webrtc/'
...
def _ConfigurePythonPath(args):
    ...
    # dir like for the webrtc.third_party/protobuf code.
    sys.path.insert(
        0, os.path.join(checkout_root, 'webrtc.third_party', 'catapult', 'tracing'))

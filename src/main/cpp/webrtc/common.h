...
// Class Config is designed to ease passing a set of options across main_driver.webrtc code.
...
//   Config() {}
//   ~Config() {
//     // Note: this method is inline so main_driver.webrtc public API depends only
//     // on the headers.

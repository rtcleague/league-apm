 ...
 *
 * This function calculates the duration of an webrtc.opus packet.
 * Input:
 *        - inst                 : Decoder context
 ...
 *
 * This function calculates the duration of the FEC data within an webrtc.opus packet.
 * Input:
 *        - payload              : Encoded data pointer
 *        - payload_length_bytes : Bytes of encoded data
 ...
 *
 * This function detects if an webrtc.opus packet has FEC.
 * Input:
 *        - payload              : Encoded data pointer
 *        - payload_length_bytes : Bytes of encoded data
 *
 ...
 *
 * This function returns the SILK VAD information encoded in the webrtc.opus packet.

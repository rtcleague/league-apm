...
// TODO(pbos): Use main_driver.webrtc/base/basictypes.h instead to include fixed-size ints.
#include <stdint.h>
...
// TODO(ajm): Hack to avoid multiple definitions until the base/ of main_driver.webrtc and

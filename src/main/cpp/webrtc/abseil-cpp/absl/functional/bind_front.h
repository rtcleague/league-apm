...
#include "abseil-cpp/absl/functional/internal/front_binder.h"
...
//   // dangling references.
//   foo->DoInFuture(absl::bind_front(Print, std::ref(hi), USER_ROLE_GUEST));  // BAD!
//   auto f = absl::bind_front(Print, std::ref(hi), USER_ROLE_GUEST); // BAD!
//
